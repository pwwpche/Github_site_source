...
http://docs.scala-lang.org/overviews/reflection/symbols-trees-types.html, ( == incorrectly reports that Histogram and List[Int] have different types.)